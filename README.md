...
(gesture, coords, command_variables) и возвращающая словарь command_variables. В качестве первого аргумента 
...
Поправлен код во всех файлах, добавлены комментарии и т.д.
