...
1. Выбор типа модели.  
![Обучение модели](git_images/export_model_type.jpg)  
Данный выпадающий список позволяет выбрать тип экспортируемой модели - YOLO или SSDLite.
2. Выбор чекпойнта.  
